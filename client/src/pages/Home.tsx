      ...
      <footer className="bg-[#0F172A] py-8 text-center text-white/50 text-sm">
        <div className="flex justify-center mb-4">
          <a
            ...
            className="inline-flex items-center gap-2 border border-white/20 text-white/60 hover:text-white hover:border-white/50 transition-all px-4 py-2 rounded text-sm"
          >
