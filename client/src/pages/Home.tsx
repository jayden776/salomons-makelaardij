    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-primary/20">
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center pt-20">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-16 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <h1 className="text-4xl md:text-5xl lg:text-6xl text-[#F5C97A] leading-tight font-serif" style={{ textShadow: "0 2px 16px rgba(0,0,0,0.8)" }}>
            onafhankelijke woningtaxaties in den helder en de kop van noord-holland
          </h1>

          <div className="mt-8 flex items-center justify-center gap-3 text-[#F5C97A] font-semibold text-sm md:text-base tracking-widest uppercase" style={{ textShadow: "0 2px 8px rgba(0,0,0,0.8)" }}>
